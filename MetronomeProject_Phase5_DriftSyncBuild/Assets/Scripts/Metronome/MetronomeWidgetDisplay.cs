...
/// </summary>
public class MetronomeWidgetDisplay : MonoBehaviour {
    ...
    /// </summary>
    public void SetMetronome(PrecisionMetronome newMetronome, string label = "") {
    ...
    public PrecisionMetronome GetMetronome() => metronome;
}