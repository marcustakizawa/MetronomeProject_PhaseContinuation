...
/// </summary>
public class MetronomeWidgetDisplay_v2 : MonoBehaviour {
    [Header("Metronome Reference")]
    [SerializeField] private PrecisionMetronome_v2_SchedulerExtract metronome; 
    ...
    private void Start() {
        ...
        if (metronome == null)
            metronome = GetComponent<PrecisionMetronome_v2_SchedulerExtract>();

        if (metronome == null) {
            Debug.LogError($"MetronomeWidgetDisplay on {gameObject.name} has no metronome assigned!");
    ...
    public void UpdateDisplay() {
        ...
        if (showBPM && bpmText != null) {
            bpmText.text = $"{metronome.Bpm:F0} BPM";
        }
    ...
    /// </summary>
    public void SetMetronome(PrecisionMetronome_v2_SchedulerExtract newMetronome, string label = "") {
    ...
    public PrecisionMetronome_v2_SchedulerExtract GetMetronome() => metronome;
}