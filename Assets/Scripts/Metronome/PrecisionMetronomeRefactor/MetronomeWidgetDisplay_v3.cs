...
/// </summary>
public class MetronomeWidgetDisplay_v3 : MonoBehaviour 
{
    [Header("Metronome Reference")]
    [SerializeField] private PrecisionMetronome_v3_StateExtract metronome;
    ...
    private void Start() {
        ...
        if (metronome == null)
            metronome = GetComponent<PrecisionMetronome_v3_StateExtract>();
    ...
    /// </summary>
    public void SetMetronome(PrecisionMetronome_v3_StateExtract newMetronome, string label = "") {
    ...
    public PrecisionMetronome_v3_StateExtract GetMetronome() => metronome;
}